export const PRESALE_ABI = [
    ...
    outputs: [
      {
        ...
        internalType: "struct PresaleStakingContract.Stake[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bool", name: "withdrawn", type: "bool" },
      { internalType: "uint256", name: "lastClaimTime", type: "uint256" },
      { internalType: "uint256", name: "withdrawalStartTime", type: "uint256" },
      { internalType: "uint256", name: "withdrawnPercentage", type: "uint256" },
      { internalType: "address", name: "referrer", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint256[3]", name: "newAPYRanges", type: "uint256[3]" },
    ],
    name: "updateAPY",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newSixMonths", type: "uint256" },
      { internalType: "uint256", name: "newOneYear", type: "uint256" },
      { internalType: "uint256", name: "newTwoYears", type: "uint256" },
    ],
